...
namespace CustomerDetails.ViewModels
{
    ...
    {
        public MainPageViewModel(IGetProfessionProvider getProfessionProvider, IGetAllPersonsProvider getAllPersonProvider, IAddPersonsProvider addPersonsProvider, IUpdatePersonsProvider updatePersonsProvider, IDeletePersonsProvider deletePersonsProvider)
        {
